#!/bin/bash
# forked from http://web.archive.org/web/20150623031217/http://matt.might.net/articles/shell-scripts-for-passive-voice-weasel-words-duplicates/

# change to read from a file
irregulars="awoken|\
been|born|beat|\
become|begun|bent|\
beset|bet|bid|\
